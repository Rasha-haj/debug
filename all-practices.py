#wrote next  to each line the changing according to the practice  (17,30,128,130,88)
...
class Student(Person):
    def __init__(self, name, age, student_id):
        ...
        self.courses = []
        self.grades = {}
        self.attendance = {} #Practice 1 change from attendence ->attendance
    ...
    def assign_grade(self, course, grade):
        if course in self.courses:
            self.grades[course].append(grade)#practice 5 use[] couse theres no key such as courses in student
...
class Course:
    ...
    def get_average_grade(self):
        ...
        total_grades_count = sum(len(student.grades[self]) for student in self.students)#practice 4 use len
...
class School:
    ...
    def get_students_with_failed_grades(self, fail_threshold=60):#practice 3 add parameter self
        failed_students = []
        for student in self.students:#practice 2 change from teachers to self.students
